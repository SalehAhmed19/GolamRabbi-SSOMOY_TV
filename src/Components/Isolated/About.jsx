...
function About() {
  ...
  return (
    <div className="bg-secondary pb-[55px] -mt-[56px]">
      <div className="lg:mx-20  mx-5 my-14">
        <h1 className="pt-[26px] -mb-20 custom-text-stroke text-center text-[100px] my-5">
          আমার সম্পর্কে
        </h1>
        <Fade down>
          <h1 className="text-white text-center text-[41px] font-bold">
            আমার সম্পর্কে
          </h1>
        </Fade>
        <AboutTabs />
