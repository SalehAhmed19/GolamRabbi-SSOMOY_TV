...
const RjModal = ({ descriptionText, open, handleClose }) => {
  const style = {
    position: "absolute",
    top: "50%",
    left: "50%",
              ...
              <div className="2xs:mt-5 2xs:text-justify lg:mt-[240px]">
                <div className="lg:flex lg:justify-center lg:items-center">
                  <img
                    ...
                    src={descriptionText?.rj?.image2}
                    alt=""
                  />
                  <p className="2xs:text-[12px] lg:w-[75%] lg:mt-[50px] lg:mr-5">
                    <span className="font-bold">
                      I {descriptionText?.rj?.name} &nbsp;
                    </span>
                    {descriptionText?.rj?.description1}
                  </p>
                </div>
              </div>
              <div className="mt-5 2xs:text-justify lg:mt-[50px]">
                <p className="2xs:text-[12px]">
                  {descriptionText?.rj?.description2}
                </p>
              </div>
              <div className="mt-5 2xs:text-justify lg:mt-[50px]">
                <p className="2xs:text-[12px]">
                  {descriptionText?.rj?.description3}
                </p>
              </div>
              <div className="mt-5 2xs:text-justify lg:mt-[50px]">
                <p className="2xs:text-[12px]">
                  {descriptionText?.rj?.description4}
                </p>
              </div>
              <div className="mt-5 2xs:text-justify lg:mt-[50px]">
                <p className="2xs:text-[12px]">
                  {descriptionText?.rj?.description5}
                </p>
              </div>
              <div className="mt-5 2xs:text-justify lg:mt-[50px]">
                <img
                  src={descriptionText?.rj?.signatureImage}
                  alt=""
                  className="2xs:my-2 w-40 bg-black"
                />
                <p className="mt-1 font-bold 2xs:text-[12px]">
                  {descriptionText?.rj?.name}
                </p>
                <p className="2xs:text-[12px] mt-1">
                  {descriptionText?.rj?.position}, &nbsp;
                  <span className="font-bold">
                    {descriptionText?.rj?.organization}
                  </span>
                </p>
              </div>
            </div>
