            ...
            <div className="relative">
              <div className="pr-8 absolute right-0">
                ...
                <h1 className="2xs:ml-[440px] xs:ml-[320px] lg:-mb-20  custom-text-stroke-5 text-center  2xs:text-[18px] xs:text-[23px] sm:text-[28px] md:text-[55px] lg:text-[100px] my-5">
                  {descriptionText?.shortBio?.stroke}
                </h1>
                ...
                <div className="lg:flex lg:justify-center lg:items-center">
                  ...
                  <p className="2xs:text-[12px] lg:w-[75%] lg:mt-[50px] lg:mr-5">
                    <span className="font-bold">
                      I {descriptionText?.shortBio?.name} &nbsp;
                    </span>
                    {descriptionText?.shortBio?.description1}
                  </p>
                </div>
              </div>
              <div className="mt-5 2xs:text-justify lg:mt-[50px]">
                <p className="2xs:text-[12px]">
                  {descriptionText?.shortBio?.description2}
                </p>
              </div>
              <div className="mt-5 2xs:text-justify lg:mt-[50px]">
                <p className="2xs:text-[12px]">
                  {descriptionText?.shortBio?.description3}
                </p>
              </div>
              <div className="mt-5 2xs:text-justify lg:mt-[50px]">
                <p className="2xs:text-[12px]">
                  {descriptionText?.shortBio?.description4}
                </p>
              </div>
              <div className="mt-5 2xs:text-justify lg:mt-[50px]">
                <p className="2xs:text-[12px]">
                  {descriptionText?.shortBio?.description5}
                </p>
              </div>
              <div className="mt-5 2xs:text-justify lg:mt-[50px]">
                <img
                  src={descriptionText?.shortBio?.signatureImage}
                  alt=""
                  className="2xs:my-2 w-40 bg-black"
                />
                <p className="mt-1 font-bold 2xs:text-[12px]">
                  {descriptionText?.shortBio?.name}
                </p>
                <p className="2xs:text-[12px] mt-1">
                  {descriptionText?.shortBio?.position}, &nbsp;
                  <span className="font-bold">
                    {descriptionText?.shortBio?.organization}
                  </span>
                </p>
              </div>
            </div>
