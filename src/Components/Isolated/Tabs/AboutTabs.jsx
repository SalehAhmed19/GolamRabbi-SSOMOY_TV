    ...
    <Box>
      ...
      <TabPanel value={value} index={0}>
        ...
        >
          <div>
            <img
              src={aboutDescriptionText?.shortBio?.image}
              alt=""
          ...
          <div className="xl:mr-[100px]">
            ...
            <p className="text-justify 2xs:text-[12px]">
              ...
              {aboutDescriptionText?.shortBio?.description1?.slice(0, 500)} ....
            </p>
            <button
              onClick={handleOpen}
              style={{ fontFamily: "Hind Siliguri" }}
            ...
            <ShortBioModal
              descriptionText={aboutDescriptionText}
              open={open}
      ...
      <TabPanel value={value} index={1}>
        ...
        >
          <div>
            <img
              src={aboutDescriptionText?.presentationCareer?.image}
              alt=""
              className="xl:-mt-32 xl:-mb-5 w-[413px] object-cover"
            />
          </div>
          <div className="xl:mr-[100px]">
            ...
            <p className="text-justify 2xs:text-[12px]">
              ...
              {aboutDescriptionText?.presentationCareer?.description1?.slice(
                0,
                500
              )}{" "}
              ....
      ...
      <TabPanel value={value} index={2}>
        ...
        >
          <div>
            <img
              src={aboutDescriptionText?.rj?.image}
              alt=""
              className="xl:-mt-32 xl:-mb-5 w-[413px] object-cover"
            />
          </div>
          <div className="xl:mr-[100px]">
            ...
            <p className="text-justify 2xs:text-[12px]">
              ...
              {aboutDescriptionText?.rj?.description1?.slice(0, 500)}
              ....
            </p>
            <button
              onClick={handleOpen}
      ...
      <TabPanel value={value} index={3}>
        ...
        >
          <div>
            <img
              src={aboutDescriptionText?.writer?.image}
              alt=""
              className="xl:-mt-32 xl:-mb-5 w-[413px] object-cover"
            />
          </div>
          <div className="xl:mr-[100px]">
            ...
            <p className="text-justify 2xs:text-[12px]">
              ...
              {aboutDescriptionText?.writer?.description1?.slice(0, 500)}
              ....
            </p>
            <button
              onClick={handleOpen}
      ...
      <TabPanel value={value} index={4}>
        ...
        >
          <div>
            <img
              src={aboutDescriptionText?.influencer?.image}
              alt=""
              className="xl:-mt-32 xl:-mb-5 w-[413px] object-cover"
            />
          </div>
          <div className="xl:mr-[100px]">
            ...
            <p className="text-justify 2xs:text-[12px]">
              ...
              {aboutDescriptionText?.influencer?.description1?.slice(0, 500)}
              ....
            </p>
            <button
              onClick={handleOpen}
